...
curl -fsSL "https://raw.githubusercontent.com/anketci54-coder/coinoskobi-dexbot/762103d5c98dd403fe761c0714bdc26e7157ce27/ops/bintrbot/test_phase0c_sequence_recovery.sh" -o "$ROOT/state/test_phase0c_sequence_recovery.sh"
